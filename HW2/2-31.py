...
plt.figure(1)
plt.subplot(1, 3, 1), plt.imshow(img, cmap=plt.cm.gray), plt.title('original image')
plt.subplot(1, 3, 2), plt.imshow(img1, cmap=plt.cm.gray), plt.title('image of noise level 1')
plt.subplot(1, 3, 3), plt.imshow(img2, cmap=plt.cm.gray), plt.title('image of noise level 2')

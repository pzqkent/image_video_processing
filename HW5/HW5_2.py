...
inputImageFirst = cv.LoadImage('Frame_q2_1.jpg', cv.CV_LOAD_IMAGE_GRAYSCALE)
inputImageSecond = cv.LoadImage('Frame_q2_4.jpg', cv.CV_LOAD_IMAGE_GRAYSCALE)


# desImageHS = cv.LoadImage(sys.argv[1], cv.CV_LOAD_IMAGE_COLOR)
# desImageLK = cv.LoadImage(sys.argv[1], cv.CV_LOAD_IMAGE_COLOR)

desImageHS = cv.LoadImage('Frame_q2_1.jpg', cv.CV_LOAD_IMAGE_COLOR)
desImageLK = cv.LoadImage('Frame_q2_1.jpg', cv.CV_LOAD_IMAGE_COLOR)
